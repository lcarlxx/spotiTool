...
-  For system audio to work, you must complete all steps above in order. Additionally, if you want to switch to microphone input, remember to go back into your sound settings and set your default recording device from Stereo Mix back to your Microphone. *(planning on fixing this soon)*
- *Fixed:* Always logged into the same spotify account regardless of user until i added a messagebox popup to ask if it was linked to that specific username to confirm.
